...
def parse_arguments():
    ...
    parser.add_argument("--config", help="Config file to use (see configs dir)", default="./src/configs/small_twins_224.yaml")
    ...
    parser.add_argument('--train_url', default="./train_log/", help='Location of training outputs.')
